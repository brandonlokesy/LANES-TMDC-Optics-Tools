...
*(A1–A3 fixed; A4 deferred; A5 open; **A6 fixed 2026-07-30**; **A7 open, reported
not fixed**.)*
...
1. **A5** and **A7** — the remaining live bugs, both small and independently
   testable. (A1 fixed 2026-07-28; A2, A3 and A6 fixed 2026-07-30; A4 deferred.)
   A7 wants the same pass as B1.
