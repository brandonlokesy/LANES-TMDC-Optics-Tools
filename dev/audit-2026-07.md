...
**E9. `plot_diffusion_cloud` is over-parameterised because its return contract is
...
**E10. The instrument export format is nowhere described — and this blocks the
...
1. **A2, A3, A5** — the remaining live bugs, each small and independently testable.
   (A1 fixed 2026-07-28; A4 is deferred.)
...
5. **E9 (with D2)** — the `plot_diffusion_cloud` signature and return shape. Last
